...
namespace PipPearl
{
    public class PipPearl : IAddon
    {
        ...
        private const float M1Speed = 19f;
        ...
        private static void InitMenu()
        {
            ...
            ComboMenu.Add(new MenuCheckBox("combo.useE", "Use E (Panic Flask)", false));
        ...
        private static void ComboMode()
        {
            ...
            (!x.HasBuff("AscensionBuff") || !x.HasBuff("AscensionTravelBuff") || !x.HasBuff("ElectricShield") || !x.HasBuff("Fleetfoot") || !x.HasBuff("TempestRushBuff")));
            ...
            if (ComboMenu.GetBoolean("combo.useEX1") && MiscUtils.CanCast(AbilitySlot.EXAbility1) && !LucieHero.IsWeaponCharged)
            {
