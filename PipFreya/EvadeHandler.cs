...
namespace PipKaan
{
    ...
    {
        public static bool EvadeExists { get; private set; } = false;
        public static EvadeSpell RuhKaanR;

        public static void Setup()
        {
            RuhKaanR = new EvadeSpell("FreyaE");
        }
        ...
        public class EvadeSpell
        {
            ...
            private void SetupOverrideMenu(Menu evadeOverrideMenu)
            {
                ...
                _overrideComboBox.Elements = new List<string>(_overrideComboBox.Elements) { "FreyaE" }.ToArray();
