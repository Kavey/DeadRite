...
namespace Hoyer.Champions.Varesh
{
    public static class MenuHandler
    {
        ...
        public static bool NeverInterruptM1;
        ...
        private static MenuCheckBox _NeverInterruptM1;
        ...
        public static void Init()
        {
            ...
            _NeverInterruptM1 = new MenuCheckBox("Varesh_NeverInterruptM1", "Never interrupt M1");
            _NeverInterruptM1.OnValueChange += delegate (ChangedValueArgs<bool> args) { NeverInterruptM1 = args.NewValue; };
            _interruptSpells.OnValueChange += delegate (ChangedValueArgs<bool> args)
            {
                InterruptSpells = args.NewValue;
                _NeverInterruptM1.Hidden = !args.NewValue;
            };
            VareshMenu.Add(_NeverInterruptM1);
        ...
        private static void FirstRun()
        {
            ...
            NeverInterruptM1 = _NeverInterruptM1;
    }
