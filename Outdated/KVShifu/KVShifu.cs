...
namespace KVShifu
{
    public class KVShifu : IAddon
    {
        ...
        private const float M2Range = 3.25f;
        ...
        private static void ComboMode()
        {
            ...
            if (ComboMenu.GetBoolean("combo.useM1") && MiscUtils.CanCast(AbilitySlot.Ability1) && !MiscUtils.CanCast(AbilitySlot.Ability2))
            {
