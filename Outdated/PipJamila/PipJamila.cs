...
namespace PipKaan
{
    public class PipKaan : IAddon
    {
        ...
        private static readonly string HeroName = "Jamila";

        private const float M2Speed = 21.5f;
        ...
        private const float FSpeed = 23.5f;
        ...
        private static void ComboMode()
        {
            ...
            var EX1Target = TargetSelector.GetTarget(enemiesToTarget, targetMode, EX1Range);
            ...
            if (!IsInUltimate)
            {
                ...
                if (ComboMenu.GetBoolean("combo.useF") && MiscUtils.CanCast(AbilitySlot.Ability7) && !KaanHero.HasBuff("ShadowStalkStealth") && !KaanHero.HasBuff("ShadowStalkTrance") && !KaanHero.HasBuff("ShadowStalkImmaterialBuff"))
                {
                    var pred = TestPrediction.GetNormalLinePrediction(myPos, FTarget, FRange, FSpeed, F_Radius, true);
                    if (pred.CanHit)
                    {
                ...
                if (ComboMenu.GetBoolean("combo.useM2") && MiscUtils.CanCast(AbilitySlot.Ability2) && !KaanHero.HasBuff("ShadowStalkStealth") && !KaanHero.HasBuff("ShadowStalkTrance") && !KaanHero.HasBuff("ShadowStalkImmaterialBuff"))
                {
                ...
                if (ComboMenu.GetBoolean("combo.useE") && MiscUtils.CanCast(AbilitySlot.Ability5) && !KaanHero.HasBuff("ShadowStalkStealth") && !KaanHero.HasBuff("ShadowStalkTrance") && !KaanHero.HasBuff("ShadowStalkImmaterialBuff"))
                {
                ...
                if (ComboMenu.GetBoolean("combo.useR") && MiscUtils.CanCast(AbilitySlot.Ability6) && !KaanHero.HasBuff("ShadowStalkStealth") && !KaanHero.HasBuff("ShadowStalkTrance") && !KaanHero.HasBuff("ShadowStalkImmaterialBuff"))
                {
                    var energyRequired = ComboMenu.GetIntSlider("combo.useR.minEnergyBars") * 25;
                    if (energyRequired <= KaanHero.Energized.Energy)
                    {
                        if (LastAbilityFired == null && KaanHero.EnemiesAroundAlive(RRange) > 0)
                        {
                            {
                ...
                if (ComboMenu.GetBoolean("combo.useEX1") && MiscUtils.CanCast(AbilitySlot.EXAbility1) && !KaanHero.HasBuff("ShadowStalkStealth") && !KaanHero.HasBuff("ShadowStalkTrance") && !KaanHero.HasBuff("ShadowStalkImmaterialBuff"))
                {
                    var energyRequired = ComboMenu.GetIntSlider("combo.useEX1.minEnergyBars") * 25;
                    if (energyRequired <= KaanHero.Energized.Energy)
                    {
                        var pred = TestPrediction.GetNormalLinePrediction(myPos, EX1Target, EX1Range, EX1Speed, EX1Radius, true);
                        if (pred.CanHit)
                        {
                ...
                if (ComboMenu.GetBoolean("combo.useSpace") && MiscUtils.CanCast(AbilitySlot.Ability3) && !KaanHero.HasBuff("ShadowStalkStealth") && !KaanHero.HasBuff("ShadowStalkTrance") && !KaanHero.HasBuff("ShadowStalkImmaterialBuff"))
                {
        ...
        private void OnDraw(EventArgs args)
        {
            ...
            if (DrawMenu.GetBoolean("draw.escapeSkillsScreen"))
            {
                var abilitySpace = LocalPlayer.GetAbilityHudData(AbilitySlot.Ability3);
                if (abilitySpace != null)
                {
                    var drawSpacePos = new Vector2(1920f - 760f, 1080f - 350f);
                ...
                if (abilityQ != null)
                {
                    var drawQPos = new Vector2(760f, 1080f - 350f);
        ...
        {
            KaanMenu = new Menu("pipjamilamenu", "DaPip's Jamila", false);
            ...
            KeysMenu.Add(new MenuKeybind("keys.heal", "Heal teammate", UnityEngine.KeyCode.Plus));
            ...
            ComboMenu.Add(new MenuSlider("combo.useM2.safeRange", "    ^ Safe range", 0f, M2Range - 1f, 0f));
            ...
            ComboMenu.Add(new MenuSlider("combo.useE.minRange", "    ^ Minimum range", 0f, ERange - 1f, 0f));
            ...
            ComboMenu.Add(new MenuCheckBox("combo.useEX1", "Use EX1 (Reaping Scythe)", true));
            ...
            ComboMenu.Add(new MenuCheckBox("combo.ultiMode.useM1", "Use Left-Mouse (Fang of the faceless)", false));
            ComboMenu.Add(new MenuCheckBox("combo.ultiMode.useM2", "Use Right-Mouse (Shadow Claw)", false));
            ...
            DrawMenu.Add(new MenuCheckBox("draw.rangeM2", "Draw Right-Mouse Range (Shadowbolt)", false));
            DrawMenu.Add(new MenuCheckBox("draw.rangeM2.safeRange", "Draw Right-Mouse Safe-Range", false));
            DrawMenu.Add(new MenuCheckBox("draw.rangeE", "Draw E Range (Claw of the wicked)", false));
            DrawMenu.Add(new MenuCheckBox("draw.rangeE.minRange", "Draw E Minimum range to use (Claw of the wicked)", false));
            DrawMenu.Add(new MenuCheckBox("draw.escapeSkillsScreen", "Draw CD cooldowns :^)", true));
