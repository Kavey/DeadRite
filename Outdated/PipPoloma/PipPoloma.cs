...
namespace PipPoloma
{
    public class PipPoloma : IAddon
    {
        ...
        private static readonly string HeroName = "Poloma";
        ...
        private const float ESpeed = 24f;
        private const float EX1Speed = 27f;
        ...
        private const float ERadius = 0.4f;
        private const float FRadius = 3.5f;
        private const float EX1Radius = 0.45f;
        ...
        {
            LucieMenu = new Menu("pipluciemenu", "kAPPA pOLOMA++ xd");
            ...
            ComboMenu.Add(new MenuCheckBox("combo.useM1", "Use Left Mouse (Toxic Bolt)", false));
            ...
            ComboMenu.Add(new MenuCheckBox("combo.useE", "TOU DOU LE LOUUU!!!", true));
        ...
        private static void ComboMode()
        {
            ...
            if (!isCastingOrChanneling && ComboMenu.GetBoolean("combo.useR") && MiscUtils.CanCast(AbilitySlot.Ability6))
            {
                ...
                {
                    if (LucieHero.EnemiesAroundAlive(M1Range) > 0)
                    {
