...
namespace PipKaan
{
    public class PipKaan : IAddon
    {
        ...
        private const float M2Speed = 23.5f;
        ...
        private const float EX1Speed = 21.5f;
        ...
        private static void ComboMode()
        {
            ...
            if (!IsInUltimate)
            {
                ...
                if (ComboMenu.GetBoolean("combo.useE") && MiscUtils.CanCast(AbilitySlot.Ability5) && !MiscUtils.CanCast(AbilitySlot.Ability4) && !KaanHero.HasBuff("Camouflage") && !KaanHero.HasBuff("Deceit"))
                {
                ...
                if (ComboMenu.GetBoolean("combo.useM2") && MiscUtils.CanCast(AbilitySlot.Ability2) && !KaanHero.HasBuff("Camouflage") && !KaanHero.HasBuff("Deceit"))
                {
                ...
                if (ComboMenu.GetBoolean("combo.useEX1") && MiscUtils.CanCast(AbilitySlot.EXAbility1) && !KaanHero.HasBuff("Camouflage") && !KaanHero.HasBuff("Deceit"))
                {
        ...
        {
            KaanMenu = new Menu("pipcroakmenu", "DaPip's Croak", false);
