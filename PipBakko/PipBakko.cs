...
namespace PipKaan
{
    public class PipKaan : IAddon
    {
        ...
        private static readonly string HeroName = "Bakko";
        ...
        private static void ComboMode()
        {
            ...
            if (!IsInUltimate)
            {
                ...
                {
					var pred = TestPrediction.GetNormalLinePrediction(myPos, FTarget, FRange, FSpeed, FRadius, true);
					if (pred.CanHit)
					{
        ...
        {
            KaanMenu = new Menu("pipbakkomenu", "DaPip's Bakko", false);
