...
namespace Hoyer.Champions.Varesh
{
    public static class MenuHandler
    {
        ...
        public static void Init()
        {
            ...
            _comboKey = new MenuKeybind("Varesh_combokey", "Combo key", KeyCode.Mouse0);
            ...
            _aimUserInput = new MenuCheckBox("Varesh_aimuserinput", "Apply aim logic when combo isn't active", false);
            _aimUserInput.OnValueChange += delegate(ChangedValueArgs<bool> args) { AimUserInput = args.NewValue; };
            VareshMenu.Add(_aimUserInput);

            _useCursor = new MenuCheckBox("Varesh_usecursor", "Use cursor pos for target selection", true);
