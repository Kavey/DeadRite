...
namespace PipOldur
{
    public class PipOldur : IAddon
    {
        ...
        private static readonly string HeroName = "Oldur";
        ...
        private const float EAirTime = 0.95f;
        ...
        private const float M1Radius = 0.35f;
        private const float M2Radius = 1.2f;
        private const float QRadius = 2f;
        private const float ERadius = 2.75f;
        ...
        {
            LucieMenu = new Menu("pipluciemenu", "DaPip's Oldur");
            ...
            KeysMenu.Add(new MenuKeybind("keys.E", "Left Mouse keybind to pause Auto Combo", UnityEngine.KeyCode.E));
            KeysMenu.Add(new MenuKeybind("keys.R", "Left Mouse keybind to pause Auto Combo", UnityEngine.KeyCode.R));
            ...
            ComboMenu.Add(new MenuCheckBox("combo.useQ", "Use Q (Clarity Potion) to remove buffs from enemies", false));
            ComboMenu.Add(new MenuCheckBox("combo.useQA", "Use Q (Clarity Potion) to cleanse allies", false));
            ...
            HealMenu.Add(new MenuSlider("heal.useM2.safeRange", "Target ally safe range", 4.25f, 10f, 0f));
            ...
            DrawingsMenu.Add(new MenuCheckBox("draw.rangeM1.safeRange", "Draw M1 range", true));
        ...
        private static void OnUpdate(EventArgs args)
        {
            ...
            if ((KeysMenu.GetKeybind("keys.M1")) || (KeysMenu.GetKeybind("keys.Space")) || (KeysMenu.GetKeybind("keys.E")) || (KeysMenu.GetKeybind("keys.R")))
            {
            ...
            if (KeysMenu.GetKeybind("keys.healSelf"))
            {
                HealSelf();
            }
        ...
        private static void ComboMode()
        {
            ...
            //OLDUR EX1
            var enemiesToTargetSands = enemiesToTargetProjs.Where(x =>
            x.HasBuff("SandsOfTimeBuff"));
            ...
            x.HasBuff("PhantomCutBuff") || x.HasBuff("EntanglingRootsBuff") || x.HasBuff("ArmorBreak") || x.HasBuff("FrostDebuff") ||
            ...
            var targetE = TargetSelector.GetTarget(enemiesToTargetSands, targetMode, ERange);
            ...
            var targetEX1 = TargetSelector.GetTarget(enemiesToTargetSands, targetMode, EX1Range);
